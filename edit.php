...
$edit = $_GET['edit'];  // return uid Value
...
while($row=mysqli_fetch_array($run))  // fetch the array row wise
{
    $uid = $row['id'];
    $name = $row['name'];
    $address = $row['address'];
...
{
    $edit = $_GET['edit'];   //  edit store in uid
    $name = $_POST['name'];
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'] . '?edit=' . $edit; ?>" method="post">  <!-- $_SERVER['PHP_SELF'] returns the name of the script that is currently being executed -->
